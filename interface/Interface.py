    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if isinstance(data, list) and data:
                ...
                st.sidebar.warning("Format inattendu.")
...
operation = st.selectbox("Choisissez une opération :", ["", "create", "get", "put", "delete", "ajouter fichier"])
    ...
    if fichiers:
        ...
        for fichier in fichiers:
            ...
            try:
                ...
                # Envoi vers MinIO dans le bucket 'datalake' sous 'unstructured/'
...
# === OPERATIONS CRUD ===
    ...
    if env:
        ...
        if operation in ["create", "put"]:
            valeur = st.number_input("Valeur", format="%.4f")
        ...
        # === PUT ===
            ...
            identifiant = st.text_input("Identifiant (UUID ou entier)")
        ...
        # === DELETE ===
            ...
            identifiant = (
                st.text_input("Identifiant (UUID)") if env == "Cassandra"
                else st.number_input("Identifiant (id)", min_value=1, step=1)
            )
